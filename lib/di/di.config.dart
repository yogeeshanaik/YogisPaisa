...
import 'package:in_app_review/in_app_review.dart' as _i18;
...
import '../features/settings/domain/use_case/json_file_import_use_case.dart'
    as _i78;
import '../features/settings/domain/use_case/setting_use_case.dart' as _i33;
import '../features/settings/domain/use_case/settings_use_case.dart' as _i31;
...
Future<_i1.GetIt> init(
  ...
  await gh.singletonAsync<_i6.Box<_i8.RecurringModel>>(
    () => hiveBoxModule.recurringBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i6.Box<_i9.DebitModel>>(
    () => hiveBoxModule.debtsBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i6.Box<_i10.CategoryModel>>(
  ...
  gh.factory<_i16.GetCountriesUseCase>(
      () => _i16.GetCountriesUseCase(repository: gh<_i13.CountryRepository>()));
  gh.singleton<_i17.ImagePicker>(serviceBoxModule.providesImagePicker());
  gh.singleton<_i18.InAppReview>(serviceBoxModule.providesInAppReview());
  gh.singleton<_i19.LocalCategoryManager>(
      _i19.LocalCategoryManagerDataSourceImpl(
          gh<_i6.Box<_i10.CategoryModel>>()));
  gh.singleton<_i20.LocalDebitDataSource>(_i20.LocalDebitDataSourceImpl(
    debtBox: gh<_i6.Box<_i9.DebitModel>>(),
    transactionsBox: gh<_i6.Box<_i11.DebitTransactionsModel>>(),
  ));
  gh.factory<_i21.LocalRecurringDataManager>(() =>
      _i22.LocalRecurringDataManagerImpl(gh<_i6.Box<_i8.RecurringModel>>()));
  ...
  gh.factory<_i34.SummaryCubit>(() => _i34.SummaryCubit());
  ...
  gh.singleton<_i76.InApp>(_i76.InApp(gh<_i18.InAppReview>()));
